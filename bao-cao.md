...
- Kiến trúc hệ thống tương đối đầy đủ cho MVP: frontend ReactJS + TypeScript, backend Node.js + Express.js + TypeScript, OCR/LLM, database, object storage, cache.
...
| 7.2, 7.3, 7.4, 7.6 còn thiếu | Stack kỹ thuật cần thống nhất với hướng triển khai mới: ReactJS + TypeScript, Node.js + Express.js + TypeScript, Leapcell. | Ảnh hưởng tiêu chí tính khả thi, chi phí, GTM. | Hoàn thiện stack: ReactJS + TypeScript, Node.js + Express.js + TypeScript, PostgreSQL/SQL Server, Redis, S3-compatible Object Storage, Leapcell. Bổ sung chi phí MVP và roadmap. |
